...
#top frames
Label(root,text="Email: s.jenisraja@gmail.com " ,width=10,heigh=3,bg="#f0687c",anchor='e').pack(side=TOP,fill=X)
...
Srch=Button(root,text="Search", compound=LEFT,image=imageicon3,height= 30,width=40,bg='#68ddfa',font="arial 8 bold",command=search)
...
Update_button.place(x=100,y=50)

#Registration and Data
Label(root,text="Registration N0:" ,font="arial 13",fg=framebg,bg=background).place(x=30,y=170)
Label(root,text="Date:",font="arial 13",fg=framebg, bg=background).place(x=500,y=170)
...
Label(obj,text="Date of Brith:",font="arial 13",bg=framebg,fg=framefg).place(x=30,y=100)
...
Class= Combobox(obj,values=['1','2','3','4','5','6','7','8','8','9','10','11','12'],font="Roboto 10",width=17,state="r")
